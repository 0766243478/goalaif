...
function AppContent() {
  ...
  useEffect(() => {
    console.log('[Sireen] App mounting, sending status checks');
  ...
  useEffect(() => {
    console.log('[Sireen] App state updated:', { apiKeySet: state.apiKeySet, connectionStatus: state.connectionStatus });
  }, [state.apiKeySet, state.connectionStatus]);
