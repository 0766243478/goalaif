...
(() => {
  ...
  // src/webview/components/Input.tsx
  function Input(props) {
    ...
    return /* @__PURE__ */ h("div", { style: wrapperStyle }, props.icon && /* @__PURE__ */ h(
      "span",
      {
        style: {
          position: "absolute",
    ...
    ), props.clearable && props.value && /* @__PURE__ */ h(
      "button",
      {
        onClick: handleClear,
        style: {
...
contract Phishing {
  ...
  function AttackWorkspace() {
    injectGlobalStyles();
    const [vectors] = createSignal(ATTACK_VECTORS);
    const [selectedVectorId, setSelectedVectorId] = createSignal(null);
    const [results, setResults] = createSignal({});
    const [filterSeverity, setFilterSeverity] = createSignal("all");
    const [searchQuery, setSearchQuery] = createSignal("");
    const [tab, setTab] = createSignal("vectors");
    const filteredVectors = createMemo(
      () => vectors().filter(
        (v) => (filterSeverity() === "all" || v.severity === filterSeverity()) && (v.name.toLowerCase().includes(searchQuery().toLowerCase()) || v.category.toLowerCase().includes(searchQuery().toLowerCase()) || v.tags.some((t) => t.includes(searchQuery().toLowerCase())))
      )
    );
    const selectedVector = createMemo(
      () => vectors().find((v) => v.id === selectedVectorId())
    );
    const handleRunVector = (vector) => {
      const result = {
        vectorId: vector.id,
        status: "running",
        startTime: Date.now()
    ...
    return /* @__PURE__ */ h("div", { style: {
      ...
      "border-bottom": "1px solid var(--vscode-panel-border)",
      background: "var(--vscode-panel-background)"
    } }, /* @__PURE__ */ h(For, { each: ["vectors", "results", "custom"] }, (t) => /* @__PURE__ */ h(
      "button",
      {
        onClick: () => setTab(t),
        style: {
      ...
      /* @__PURE__ */ h("option", { value: "all" }, "All Severities"),
      /* @__PURE__ */ h("option", { value: "critical" }, "Critical"),
      /* @__PURE__ */ h("option", { value: "high" }, "High"),
      /* @__PURE__ */ h("option", { value: "medium" }, "Medium"),
      /* @__PURE__ */ h("option", { value: "low" }, "Low")
    )), /* @__PURE__ */ h("div", { style: { flex: 1, overflow: "auto" } }, /* @__PURE__ */ h(Show, { when: tab() === "vectors" }, () => /* @__PURE__ */ h("div", { style: { padding: "12px", display: "flex", "flex-direction": "column", gap: "8px" } }, /* @__PURE__ */ h(For, { each: filteredVectors() }, (vector) => {
      ...
      return /* @__PURE__ */ h(
        Panel,
        {
          ...
          style: { cursor: "pointer", transition: "border-color 120ms", borderColor: selectedVectorId() === vector.id ? cfg.color : void 0 }
        },
        /* @__PURE__ */ h("div", { style: { display: "flex", "align-items": "flex-start", gap: "12px" } }, /* @__PURE__ */ h("div", { style: { width: 4, height: "100%", "border-radius": "2px", background: cfg.color, "flex-shrink": 0, marginTop: "2px" } }), /* @__PURE__ */ h("div", { style: { flex: 1, "min-width": 0 } }, /* @__PURE__ */ h("div", { style: { display: "flex", "align-items": "center", gap: "8px", "margin-bottom": "4px" } }, /* @__PURE__ */ h("span", { style: { "font-weight": 600 } }, vector.name), /* @__PURE__ */ h(Badge, { variant: severityBadge(vector.severity), size: "sm" }, cfg.label), /* @__PURE__ */ h("span", { style: { "font-size": "10px", color: "var(--vscode-descriptionForeground)" } }, vector.category), result && /* @__PURE__ */ h(
          Badge,
          {
            variant: result.status === "success" ? "success" : result.status === "failed" ? "danger" : result.status === "running" ? "info" : "default",
            size: "sm"
          },
          result.status
      ...
      if (!vector)
        return null;
      const cfg = SEVERITY_CONFIG[vector.severity];
      return /* @__PURE__ */ h(Panel, { variant: "bordered", padding: "md" }, /* @__PURE__ */ h("div", { style: { display: "flex", "align-items": "flex-start", gap: "12px" } }, /* @__PURE__ */ h("div", { style: { width: 4, height: "100%", "border-radius": "2px", background: cfg.color, "flex-shrink": 0, marginTop: "2px" } }), /* @__PURE__ */ h("div", { style: { flex: 1, "min-width": 0 } }, /* @__PURE__ */ h("div", { style: { display: "flex", "align-items": "center", gap: "8px", "margin-bottom": "4px" } }, /* @__PURE__ */ h("span", { style: { "font-weight": 600 } }, vector.name), /* @__PURE__ */ h(Badge, { variant: severityBadge(vector.severity), size: "sm" }, cfg.label), /* @__PURE__ */ h(
        Badge,
        {
          variant: result.status === "success" ? "success" : result.status === "failed" ? "danger" : result.status === "running" ? "info" : "default",
          size: "sm"
        ...
        result.status
      ), /* @__PURE__ */ h("span", { style: { "font-size": "10px", color: "var(--vscode-descriptionForeground)", marginLeft: "auto" } }, formatTime(result.startTime), result.endTime && ` \xB7 ${Math.round((result.endTime - result.startTime) / 1e3)}s`)), result.output && /* @__PURE__ */ h("pre", { style: { margin: "8px 0 0", padding: "8px", background: "var(--vscode-textCodeBlock-background)", "border-radius": "2px", "font-size": "10px", "font-family": "var(--vscode-editor-font-family)", overflow: "auto", "max-height": 200 } }, result.output), result.error && /* @__PURE__ */ h("div", { style: { marginTop: "8px", padding: "8px", background: "color-mix(in srgb, var(--vscode-testing-iconFailed) 12%, transparent)", "border-radius": "2px", border: "1px solid var(--vscode-testing-iconFailed)", "font-size": "10px", color: "var(--vscode-testing-iconFailed)" } }, result.error), result.findings && result.findings.length > 0 && /* @__PURE__ */ h("div", { style: { marginTop: "8px" } }, /* @__PURE__ */ h("span", { style: { "font-size": "10px", "font-weight": 600, color: "var(--vscode-descriptionForeground)" } }, "Findings:"), /* @__PURE__ */ h("ul", { style: { margin: "4px 0 0", paddingLeft: "16px", "font-size": "10px" } }, result.findings.map((f) => /* @__PURE__ */ h("li", { key: f, style: { color: "var(--vscode-descriptionForeground)" } }, f))))), /* @__PURE__ */ h("div", { style: { display: "flex", "flex-direction": "column", gap: "4px" } }, /* @__PURE__ */ h(Button, { variant: "ghost", size: "sm", onClick: () => postMessage({ type: "attack:copyResult", payload: { vectorId: id } }) }, /* @__PURE__ */ h(IconCopy, { size: 12 }), " Copy"), /* @__PURE__ */ h(Button, { variant: "ghost", size: "sm", onClick: () => setResults((prev) => {
        const n = { ...prev };
        delete n[id];
        return n;
      }) }, /* @__PURE__ */ h(IconX, { size: 12 }), " Clear"))));
    }), Object.keys(results()).length === 0 && /* @__PURE__ */ h("div", { style: { padding: "24px", "text-align": "center", color: "var(--vscode-descriptionForeground)" } }, /* @__PURE__ */ h(IconActivity, { style: { width: 32, height: 32, marginBottom: "8px", opacity: 0.3 } }), /* @__PURE__ */ h("p", null, "No attack runs yet. Switch to Vectors tab to start.")))), /* @__PURE__ */ h(Show, { when: tab() === "custom" }, () => /* @__PURE__ */ h("div", { style: { padding: "16px", "max-width": 600, margin: "0 auto", display: "flex", "flex-direction": "column", gap: "12px" } }, /* @__PURE__ */ h(Panel, { variant: "bordered", padding: "md" }, /* @__PURE__ */ h("h3", { style: { margin: "0 0 12px", "font-size": "var(--vscode-font-size)", "font-weight": 600 } }, "Custom Attack Vector"), /* @__PURE__ */ h("div", { style: { display: "flex", "flex-direction": "column", gap: "8px" } }, /* @__PURE__ */ h(Input, { placeholder: "Vector name (e.g., MyCustomExploit)", style: { width: "100%" } }), /* @__PURE__ */ h(Input, { placeholder: "Category", style: { width: "100%" } }), /* @__PURE__ */ h("select", { style: { width: "100%", padding: "4px 8px", "font-size": "var(--vscode-font-size)", background: "var(--vscode-dropdown-background)", border: "1px solid var(--vscode-dropdown-border)", "border-radius": "2px", color: "var(--vscode-dropdown-foreground)" } }, /* @__PURE__ */ h("option", { value: "critical" }, "Critical"), /* @__PURE__ */ h("option", { value: "high" }, "High"), /* @__PURE__ */ h("option", { value: "medium" }, "Medium"), /* @__PURE__ */ h("option", { value: "low" }, "Low")), /* @__PURE__ */ h(
      "textarea",
      {
    ...
    ), /* @__PURE__ */ h(Button, { variant: "primary", size: "sm", onClick: () => postMessage({ type: "attack:saveCustom", payload: {} }) }, /* @__PURE__ */ h(IconPlus, { size: 12 }), " Save Vector")))))));
  }
  var root = document.getElementById("root");
  if (root) {
    render(() => /* @__PURE__ */ h(AttackWorkspace, null), root);
  }
})();
//# sourceMappingURL=attack-workspace.js.map
