...
(() => {
  ...
  function Sidebar() {
    ...
    const [mode, setMode] = createSignal("recon");
    ...
    createEffect(() => {
      const handler = (event) => {
        ...
        switch (msg.type) {
          case "config":
            if (msg.payload?.defaultMode)
              setMode(msg.payload.defaultMode);
            if (msg.payload?.defaultChain)
              setChain(msg.payload.defaultChain);
            break;
          case "chat:message":
          ...
          case "investigation:list":
            if (msg.payload?.investigations?.length > 0)
              setHasInvestigation(true);
            break;
        }
      };
    ...
    const handleSubmitInput = (value, type) => {
      if (!value.trim())
        return;
      setShowInput(false);
      setHasInvestigation(true);
    ...
    return /* @__PURE__ */ h(
      ...
      /* @__PURE__ */ h(
        ...
        /* @__PURE__ */ h("div", { style: { display: "flex", "align-items": "center", gap: "7px" } }, /* @__PURE__ */ h("span", { style: { display: "flex", color: "var(--vscode-button-background)" } }, /* @__PURE__ */ h(IconShield, { size: 15 })), /* @__PURE__ */ h("span", { style: { "font-size": "var(--vscode-font-size)", "font-weight": "600" } }, "Sireen")),
        /* @__PURE__ */ h("div", { style: { display: "flex", gap: "1px" } }, /* @__PURE__ */ h(
          Button,
          {
            variant: "ghost",
            size: "sm",
            icon: /* @__PURE__ */ h(IconPlus, { size: 13 }),
          ...
          Button,
          {
            variant: "ghost",
            size: "sm",
            icon: /* @__PURE__ */ h(IconHistory, { size: 13 }),
          ...
          Button,
          {
            variant: "ghost",
            size: "sm",
            icon: /* @__PURE__ */ h(IconSettings, { size: 13 }),
      ...
      /* @__PURE__ */ h(Show, { when: !hasInvestigation() && showInput() }, /* @__PURE__ */ h(
        "div",
        {
          style: {
            padding: "10px",
        ...
        /* @__PURE__ */ h("label", { style: { "font-size": "11px", color: "var(--vscode-descriptionForeground)" } }, "Contract address or paste Solidity code"),
        /* @__PURE__ */ h(
          "textarea",
          {
            value: inputValue(),
        ...
        /* @__PURE__ */ h("div", { style: { display: "flex", gap: "8px" } }, /* @__PURE__ */ h(
          "select",
          {
            value: chain(),
          ...
          /* @__PURE__ */ h("option", { value: "ethereum" }, "Ethereum"),
          /* @__PURE__ */ h("option", { value: "polygon" }, "Polygon"),
          /* @__PURE__ */ h("option", { value: "arbitrum" }, "Arbitrum"),
          /* @__PURE__ */ h("option", { value: "optimism" }, "Optimism"),
          /* @__PURE__ */ h("option", { value: "bsc" }, "BSC"),
          /* @__PURE__ */ h("option", { value: "base" }, "Base"),
          /* @__PURE__ */ h("option", { value: "solana" }, "Solana")
        ), /* @__PURE__ */ h(Button, { variant: "primary", size: "sm", onClick: () => handleSubmitInput(inputValue(), inputValue().startsWith("0x") ? "address" : "code"), disabled: !inputValue().trim() }, "Analyze"))
      )),
      /* @__PURE__ */ h(Show, { when: hasInvestigation() }, /* @__PURE__ */ h(
        "nav",
        {
          style: {
            display: "flex",
        ...
        /* @__PURE__ */ h(For, { each: TABS }, (tab) => {
          ...
          return /* @__PURE__ */ h(
            ...
            /* @__PURE__ */ h("span", { style: { display: "flex" } }, tab.icon({ size: 13 })),
            tab.label
          );
        })
      )),
      /* @__PURE__ */ h(
        ...
        /* @__PURE__ */ h(Show, { when: !hasInvestigation() && !showInput() }, /* @__PURE__ */ h(
          ...
          /* @__PURE__ */ h(Button, { variant: "primary", size: "md", icon: /* @__PURE__ */ h(IconPlus, { size: 13 }), onClick: handleNewInvestigation }, "New Investigation")
        )),
        /* @__PURE__ */ h(Show, { when: !hasInvestigation() && showInput() }, /* @__PURE__ */ h("div", { style: { padding: "10px", display: "flex", "flex-direction": "column", gap: "8px" } }, /* @__PURE__ */ h(
          EmptyPanel,
          {
            icon: IconMessage,
        ...
        /* @__PURE__ */ h(Show, { when: hasInvestigation() && activeTab() === "chat" }, /* @__PURE__ */ h(
          "div",
          {
            style: {
              flex: "1",
          ...
          /* @__PURE__ */ h(Show, { when: messages().length === 0 }, /* @__PURE__ */ h(
            EmptyPanel,
            {
              icon: IconMessage,
          ...
          /* @__PURE__ */ h(For, { each: messages() }, (msg) => /* @__PURE__ */ h(
            "div",
            {
              style: {
                display: "flex",
          ...
          /* @__PURE__ */ h(Show, { when: isStreaming() }, /* @__PURE__ */ h(
            "div",
            {
              style: {
                display: "flex",
            ...
            /* @__PURE__ */ h("span", { style: { display: "flex", animation: "spin 1s linear infinite" } }, /* @__PURE__ */ h(IconLoader, { size: 12 })),
            "Thinking\u2026"
          ))
        )),
        /* @__PURE__ */ h(Show, { when: hasInvestigation() && activeTab() === "findings" }, /* @__PURE__ */ h(
          EmptyPanel,
          {
            icon: IconSearch,
            title: "No findings",
      ...
      /* @__PURE__ */ h(Show, { when: hasInvestigation() }, /* @__PURE__ */ h(
        ...
        /* @__PURE__ */ h(
          ...
          /* @__PURE__ */ h(
            ...
            isStreaming() ? /* @__PURE__ */ h(IconLoader, { size: 12 }) : /* @__PURE__ */ h(IconSend, { size: 12 })
          )
        )
      ))
    );
  ...
  if (root) {
    render(() => /* @__PURE__ */ h(Sidebar, null), root);
  }
})();
