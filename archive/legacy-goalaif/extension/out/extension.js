...
function activate(context) {
    ...
    const sidebar = new sidebar_1.GoalAIFSidebarProvider(context.extensionUri);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("goalaif.sidebar", sidebar));
