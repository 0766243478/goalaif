...
export class HonestSignalEvaluator {
  ...
  private checkStateChangeVerified(
    ...
    // Traces are one form of evidence; state changes are another. We no longer
    // require traces to be non-empty — if the PoC emitted real state-change
    // evidence (e.g. via derived money-flow/balance deltas), that is sufficient.
